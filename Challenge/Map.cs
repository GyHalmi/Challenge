...
namespace Challenge
{
    ...
    class Map
    {
        public static int[][] initMap(int y, int x)
        {
            int[][] mapCoordinates;
        ...
        {
            Heading defaultHeadingUP = RoboCleaner.defaultHeadingUP;
            int xMax = 0;
            ...
            PutRoboCleanerOnMap(new Position(y, x),defaultHeadingUP);
            ...
            bool search()
            {
                ...
                if (CoordinateFigureByPosition(p) == (int)Figure.UncleanedArea)
                {
                    ...
                    if (CoordinateFigureByPosition(AreaOnTheFront(defaultHeadingUP, p)) == wall ||
                        CoordinateFigureByPosition(AreaOnTheLeft(defaultHeadingUP, p)) == wall ||
                        CoordinateFigureByPosition(AreaOnTheRight(defaultHeadingUP, p)) == wall ||
